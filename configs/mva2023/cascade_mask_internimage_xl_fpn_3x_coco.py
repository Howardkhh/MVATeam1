...
_base_ = [
    ...
    # '../_base_/datasets/coco_instance.py',#TODO: 
    './drone_mvaCrop_mask_dataset.py',
...
# MVA2023: replace the train_pipeline with the drone_mvaCrop_mask_dataset
# TODO: try this train_pipeline later
# train_pipeline = [
