...
class FilterAnnotations:
    ...
    def __init__(self, min_gt_bbox_wh, max_gt_bbox_wh, keep_empty=True):
        # TODO: add more filter options
        self.min_gt_bbox_wh = min_gt_bbox_wh
        self.max_gt_bbox_wh = max_gt_bbox_wh
    ...
    def __call__(self, results):
        ...
        keep = (w > self.min_gt_bbox_wh[0]) & (h > self.min_gt_bbox_wh[1]) & (w < self.max_gt_bbox_wh[0]) & (h < self.max_gt_bbox_wh[1])
        if not keep.any():
            if self.keep_empty:
                return None
            else:
